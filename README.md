# guardian-score-client-java[![GitHub Packages](https://img.shields.io/badge/Maven&nbsp;package-Last&nbsp;version-lemon)](https://github.com/orgs/APIHub-CdC/packages?repo_name=guardian-score-client-java) 
...
Para hacer uso del certificado que se descargó y el keystore que se creó se deberán modificar las rutas que se encuentran en ***src/main/java/resources/config.properties***.
```properties
...
En el archivo ApiTest.java, que se encuentra en ***src/test/java/io/GuardianScore/client/api/***. Se deberá modificar los datos de la petición y los datos de consumo:
